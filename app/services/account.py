...
class AccountService:
    ...
    async def update_reg_status(self, data: PutAccountRegStatusDto) -> tuple[dict, str]:
        async with self._db_session.begin():
            return await self._account_repository.update_account_status(data.account_id, data.status)
